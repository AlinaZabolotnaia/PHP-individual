...
### **Тема работы:**  
# «Дневник задач» (PHP-проект)

---

**Руководитель:** _______________ Фамилия Имя, учёная степень  
(подпись)

**Автор:** _______________ Alina Korsakova (Zabolotnaia)  
(подпись)
...
- **Главная страница:**
![alt text](<Screenshot 2025-11-27 at 12.40.04.png>)
